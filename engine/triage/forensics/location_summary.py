...
<title>Location Summary — SNAGR Forensic Engine</title>
<meta name="description" content="GPS location analysis summary generated by SNAGR forensic engine.">
<style>
  :root {{
    --bg: #0b0f1a;
    --surface: #131929;
...
<header class="page-header">
  ...
  <p class="subtitle">GPS trace summary — generated by SNAGR forensic engine</p>
</header>
