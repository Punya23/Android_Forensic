...
class Translator:
    def __init__(self, dictionary_path: Path = None):
        ...
        self.translations = {
            "hi": {"Report": "रिपोर्ट", "Evidence": "सबूत", "Scam Detection Analysis": "घोटाला पहचान विश्लेषण"},
            "ta": {"Report": "அறிக்கை", "Evidence": "சான்று", "Scam Detection Analysis": "மோசடி கண்டறிதல் பகுப்பாய்வு"},
            "te": {"Report": "నివేదిక", "Evidence": "సాక్ష్యం", "Scam Detection Analysis": "స్కామ్ డిటెక్షన్ అనాలిసిస్"},
            "kn": {"Report": "ವರದಿ", "Evidence": "ಪುರಾವೆ", "Scam Detection Analysis": "ಸ್ಕ್ಯಾಮ್ ಪತ್ತೆ ವಿಶ್ಲೇಷಣೆ"},
            "mr": {"Report": "अहवाल", "Evidence": "पुरावा", "Scam Detection Analysis": "घोटाळा शोध विश्लेषण"}
        }
    ...
    def translate_report(self, report_path: Path, target_lang: str) -> Path:
        ...
        out_path = report_path.with_name(f"{report_path.stem}_{target_lang}{report_path.suffix}")
