...
def assess_risk(
    *,
    ...
    if anti_forensic:
        ...
        names = sorted(
            {
                a.get("friendly_name") or a.get("label") or a.get("package", "")
        ...
        reasons.append(
            {
                "points": pts,
                "label": "vault / anti-forensic app installed",
    ...
    if known_hash:
        ...
        reasons.append(
            {
                "points": 60,
                "label": "known-hash content match",
    ...
    if deleted:
        ...
        reasons.append(
            {
                "points": pts,
                "label": "recovered deleted content",
    ...
    in_recovered = [
        f for f in flags if "recovered" in (f.get("location") or "").lower()
    ]
    if in_recovered:
        score += 10
        reasons.append(
            {
                "points": 10,
                "label": "keywords inside deleted content",
